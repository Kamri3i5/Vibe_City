...
$router->get('/places/{id}/vibes', [VibeController::class, 'indexByPlace']);
$router->get('/activity-feed', [VibeController::class, 'activityFeed']);
$router->get('/hot-places', [PlaceController::class, 'hotPlaces']);
